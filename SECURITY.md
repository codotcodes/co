...
Security fixes are applied to the latest released minor version. Upgrade to the latest release before reporting a reproducibility issue.
...
We will acknowledge a report within three business days and coordinate disclosure after a fix is available.
